...
file = URI.open('https://res.cloudinary.com/deqc25xt2/image/upload/v1654261316/development/toto_hrhpfp.jpg')
...
book5 =Book.create(
  ...
  ")
file = URI.open('https://res.cloudinary.com/deqc25xt2/image/upload/v1654261315/development/js_for_dummies_prg4fz.jpg')
book5.photo.attach(io: file, filename: 'nes.png', content_type: 'image/png')
...
file = URI.open('https://res.cloudinary.com/deqc25xt2/image/upload/v1654261315/development/harry_potter_alhvem.jpg')
book6.photo.attach(io: file, filename: 'nes.png', content_type: 'image/png')
...
file = URI.open('https://res.cloudinary.com/deqc25xt2/image/upload/v1654261314/development/l_alchimiste_axsrhr.jpg')
book7.photo.attach(io: file, filename: 'nes.png', content_type: 'image/png')
...
file = URI.open('')
book8.photo.attach(io: file, filename: 'nes.png', content_type: 'image/png')
...
file = URI.open('https://res.cloudinary.com/deqc25xt2/image/upload/v1654261315/development/ruby_on_rails_ddveko.jpg')
book9.photo.attach(io: file, filename: 'nes.png', content_type: 'image/png')
...
file = URI.open('https://res.cloudinary.com/deqc25xt2/image/upload/v1654261316/development/tintin-and-the-picaros_meyq8k.jpg')
book10.photo.attach(io: file, filename: 'nes.png', content_type: 'image/png')
...
file = URI.open('https://res.cloudinary.com/deqc25xt2/image/upload/v1654261315/development/romeo_and_juliet_pt8wia.jpg')
book11.photo.attach(io: file, filename: 'nes.png', content_type: 'image/png')
...
file = URI.open('https://res.cloudinary.com/deqc25xt2/image/upload/v1654261316/development/kamasutra_xzbi0p.jpg')
book12.photo.attach(io: file, filename: 'nes.png', content_type: 'image/png')
...
file = URI.open('https://res.cloudinary.com/deqc25xt2/image/upload/v1654261315/development/titeuf_xdzi8w.jpg')
book13.photo.attach(io: file, filename: 'nes.png', content_type: 'image/png')
...
book14 = Book.create(
  ...
  description: "A book for the curious, and Billy, but don't be too curious.... Might get shocked")
file = URI.open('https://res.cloudinary.com/deqc25xt2/image/upload/v1654261317/development/Madame_Bovary_1857__hi-res_cnz0cs.jpg')
book14.photo.attach(io: file, filename: 'nes.png', content_type: 'image/png')
